        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/sharmajee.iit?igsh=cjhpeWE4dGlwa2wx" className="bg-pink-600 p-3 rounded-lg hover:bg-pink-700 transition-colors duration-300 group">
                <Instagram className="h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
              </a>
              <a href="https://youtube.com/@sharmajee.vsh7?si=jUyLNt8AhixaO66O" className="bg-red-600 p-3 rounded-lg hover:bg-red-700 transition-colors duration-300 group">
                <Youtube className="h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
              </a>
              <a href="https://api.whatsapp.com/send/?phone=919599579007&text=Hi this is helpline Number of SharmaJEE" className="bg-green-600 p-3 rounded-lg hover:bg-green-700 transition-colors duration-300 group">
                <MessageSquare className="h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
              </a>
              <a href="https://www.linkedin.com/in/vaibhavvsh7?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" className="bg-blue-600 p-3 rounded-lg hover:bg-blue -700 transition-colors duration-300 group">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3 text-gray-300">
                ...
                <a href='https://maps.app.goo.gl/dCVqgknHXKmvFKcE9'>3rd Floor, Orchid City Center,
Sector 53, Gurgoan.</a>
              </li>
            </ul>
          </div>
